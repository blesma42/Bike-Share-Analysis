...
* Member trips are short, on average 22 min
...
From 5,595,063 rows `r format(5595063-nrow(df), big.mark=',')` or `r format(round(nrow(df)/5595063*100, 2))` % got removed during cleaning. This amount could indicate an issue with the system, which collects the data and writes it into the data base. 
